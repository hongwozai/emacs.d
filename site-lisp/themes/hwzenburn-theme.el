;;; 本文件经过hongwozai(luzeya)修改，原始文件是Bozhidar Batsov的zenburn-theme.el
;;; 为了不与原文件重名，更改文件名主题名为hwzenburn
;;; Code:

(deftheme hwzenburn "The hwZenburn color theme")
...
;;;;; mode-line
   `(mode-line
     ((,class (:foreground ,zenburn-green+1
      ...
      (t :inverse-video t)))
   `(mode-line-inactive ((t (:foreground ,zenburn-fg+1
                                         :background ,zenburn-bg+05
                                         :box (:line-width 1 :color ,zenburn-bg+3)))))
...
;;;;; font lock
   ...
   `(font-lock-type-face ((t (:foreground ,zenburn-blue+05))))
...
;;;;; anzu
   `(anzu-mode-line ((t (:foreground "goldenrod" :weight bold))))
;;;;; auctex
...
;;;;; highlight-symbol
   `(highlight-symbol-face ((t (:foreground ,zenburn-bg-1 :background ,zenburn-select))))
